...
class PWAlignment:
    def __init__(self, seq1, seq2, seq_type):
        ...
        if seq_type == 'dna':
            self.create_scores_dict("llp/data/config/dna_dist.txt")
        elif seq_type == 'rna':
            self.create_scores_dict("llp/data/config/rna_dist.txt")
        elif seq_type == 'protein':
            self.create_scores_dict("llp/data/config/protein_dist.txt")
        else:
